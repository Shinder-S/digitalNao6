module.exports = app => {
  ...
  router.get('/restaurants/nearby', restaurantController.findNearbyRestaurants);

  // Routes for aggregations
  router.get('/restaurants/statistics', restaurantController.getRatingStatistics);
